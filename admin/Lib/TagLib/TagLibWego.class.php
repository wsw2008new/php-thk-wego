...
class TagLibWego extends TagLib{
    // 标签定义
     ...
     * @return string|void
     ...
     public function _calendar($attr,$content){     	
        ...
        $name   	=	$tag['name'];
        $ifformat	=	!empty($tag['ifformat'])?$tag['ifformat']:'%Y-%m-%d';
     ...
     //   $content    =   $tag['content'];
        ...
        switch(strtoupper($type)) {
            ...
            case 'UBB':
                ...
                break;
            case 'KINDEDITOR':                
                $parseStr='<script type="text/javascript" src="__ROOT__/includes/kindeditor/kindeditor.js"></script><script type="text/javascript" src="__ROOT__/includes/kindeditor/lang/zh_CN.js"></script><script> var editor; KindEditor.ready(function(K) { editor = K.create(\'#'.$id.'\');});</script><textarea id="'.$id.'" style="'.$style.'" name="'.$name.'" >'.$content.'</textarea>';
                break;
            default :
