...
</script><div class="wrapper clearfix"><link rel="stylesheet" type="text/css" href="__TMPL__public/css/seller_promo.css" /><!--B2C随机广告--><div class="mt15"><?php if(is_array($ad_rel)): $key = 0; $__LIST__ = $ad_rel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($key % 2 );++$key; if($key == 1): ?><a href="javascript:void(0)" style="border:none; margin-right:20px;" onclick="window.open('<?php echo ($val['click_url']); ?>')"><img src="<?php echo ($val["pic_url"]); ?>" /></a><?php else: ?><a href="javascript:void(0)" style="border:none;" onclick="window.open('<?php echo ($val['click_url']); ?>')"><img src="<?php echo ($val["pic_url"]); ?>" /></a><?php endif; endforeach; endif; else: echo "" ;endif; ?></div><!--B2C随机广告结束--><div id="group_nav" class="clearfix"><ul><?php if(is_array($promo_cate)): $i = 0; $__LIST__ = $promo_cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i; if($val['cid'] == $cid): ?><li><a class="on" href="<?php echo u('promo/cate',array('cid'=>$val['cid']));?>"><?php echo ($val["name"]); ?></a></li><?php else: ?><li><a href="<?php echo u('promo/cate',array('cid'=>$val['cid']));?>"><?php echo ($val["name"]); ?></a></li><?php endif; endforeach; endif; else: echo "" ;endif; ?></ul><div class="promo_cate_child"><p><?php if(is_array($child_data)): $i = 0; $__LIST__ = $child_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i; if($val['cid'] == $real_cid): ?><a class="hover" href="<?php echo u('promo/cate',array('cid'=>$val['cid'],'pid'=>$cid));?>"><?php echo ($val["name"]); ?></a><?php else: ?><a href="<?php echo u('promo/cate',array('cid'=>$val['cid'],'pid'=>$cid));?>"><?php echo ($val["name"]); ?></a><?php endif; endforeach; endif; else: echo "" ;endif; ?></p></div></div><div class="yhhdbt"><h1><?php echo ($curent_name); ?></h1></div><div class="cxhdym"><?php if(is_array($promos)): $i = 0; $__LIST__ = $promos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><div class="cxhd"><div class="cxhd_a"><a href="<?php echo u('item/urlpromo',array('url'=>$val['click_url']));?>" class="sde" target="_blank"><?php echo ($val["seller_name"]); ?></a>&nbsp;<a href="<?php echo u('item/urlpromo',array('url'=>$val['seller_url']));?>" target="_blank"><?php echo ($val["title"]); ?></a></div><div class="chxztp"><a href="<?php echo u('item/urlpromo',array('url'=>$val['click_url']));?>"  target="_blank"><img src="<?php echo ($val["pic_url_1"]); ?>" width="300" height="300" /></a></div><div class="chxz_b"><div class="chxz_b1"><a href="<?php echo u('item/urlpromo',array('url'=>$val['seller_url']));?>" target="_blank"><img src="<?php echo ($val["seller_logo"]); ?>" width="120" height="45" /></a></div><div class="chxz_b2">	            	有效期:<?php echo ($val["start_time"]); ?>- <?php echo ($val["end_time"]); ?></div></div></div><?php endforeach; endif; else: echo "" ;endif; ?><div style="clear:both;"></div></div><div class="page_b"><?php echo ($page); ?></div></div><div class="foot"><div class="footer"><div class="footlj"><div class="logo2"><a href="./"><img src="__TMPL__public/images/logo2.png" /></a></div><div class="footlj_a"><h6>逛宝贝</h6><ul><li><a target="_blank" href="<?php echo U('cate/index',array('cid'=>548));?>">衣服</a></li><li><a target="_blank" href="<?php echo U('cate/index',array('cid'=>2));?>">鞋子</a></li><li><a target="_blank" href="<?php echo U('cate/index',array('cid'=>3));?>">包包</a></li><li><a target="_blank" href="<?php echo U('cate/index',array('cid'=>4));?>">配饰</a></li><li><a target="_blank" href="<?php echo U('cate/index',array('cid'=>5));?>">美妆</a></li><li><a target="_blank" href="<?php echo U('cate/index',array('cid'=>6));?>">家居</a></li></ul></div><div class="footlj_a"><h6>关于我们</h6><ul><?php if(is_array($fabout)): $i = 0; $__LIST__ = $fabout;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a target="_blank" href="<?php if(($vo["url"]) == ""): echo u('article/index',array('id'=>$vo['id'])); else: echo ($vo["url"]); endif; ?>"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></div><div class="footlj_a"><h6>合作伙伴</h6><ul><?php if(is_array($huoban_list)): $i = 0; $__LIST__ = $huoban_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li><a target="_blank" href="<?php echo ($val["url"]); ?>"><?php echo ($val["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></div><div class="footlj_a footlj_b"><h6>友情链接</h6><ul><?php if(is_array($flink_list)): $i = 0; $__LIST__ = $flink_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li><a target="_blank" href="<?php echo ($val["url"]); ?>" class="f_links fl"><?php echo ($val["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?></ul></div><div class="footlj_a footlj_c"><h6>关注我们</h6><ul><?php if(($follow_us["weibo_url"]) != ""): ?><li><a href="<?php echo ($follow_us["weibo_url"]); ?>">新浪微博</a></li><?php endif; if(($follow_us["qqweibo_url"]) != ""): ?><li><a href="<?php echo ($follow_us["qqweibo_url"]); ?>" style="background:url(__TMPL__public/images/guanz5.png) no-repeat;">腾讯微博</a></li><?php endif; if(($follow_us["163_url"]) != ""): ?><li><a href="<?php echo ($follow_us["163_url"]); ?>" style="background:url(__TMPL__public/images/guanz6.png) no-repeat;">网易微博</a></li><?php endif; if(($follow_us["qqzone_url"]) != ""): ?><li><a href="<?php echo ($follow_us["qqzone_url"]); ?>" style="background:url(__TMPL__public/images/guanz2.png) no-repeat;">QQ空间</a></li><?php endif; if(($follow_us["douban_url"]) != ""): ?><li><a href="<?php echo ($follow_us["douban_url"]); ?>" style="background:url(__TMPL__public/images/guanz3.png) no-repeat;">豆瓣</a></li><?php endif; if(($follow_us["renren_url"]) != ""): ?><li><a href="<?php echo ($follow_us["renren_url"]); ?>" style="background:url(__TMPL__public/images/guanz4.png) no-repeat;">人人网</a></li><?php endif; ?></ul></div></div><div class="banquan">Powered by <a href="<?php echo ($site_domain); ?>"><?php echo ($site_name); ?></a>&nbsp;&nbsp;<?php echo ($site_icp); ?></div><div  class="banquan"><?php echo ($statistics_code); ?></div><div class="banquan"><?php echo ($site_share); ?></div><div class="browse none_f"><a class="close_z"></a>        	温馨提示：你正在使用的<b>IE6浏览器</b>，网购支付不安全，<?php echo ($site_name); ?>推荐 
